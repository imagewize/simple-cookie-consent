...
const defaultConfig = {
    ...
    // FIXED: Using the correct structure expected by the library
    languages: {
        en: {
            consent_modal: {
    ...
    // FIXED: Added GUI options to ensure proper DOM element handling
    gui_options: {
        consent_modal: {
            layout: 'cloud',
...
// Wait for full page load, not just DOM content
window.addEventListener('load', function() {
    try {
        ...
        if (typeof window.sccSettings !== 'undefined') {
            ...
            // FIXED: Use correct language structure with 'languages'
        ...
        // Initialize cookie consent with a small timeout to ensure DOM is fully ready
        setTimeout(() => {
